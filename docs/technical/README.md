...
Read the [API reference](../api.md) for the public contract, then use these guides:
...
Source links refer to this checkout. Update user-facing documentation and
boundary tests alongside contract changes.
