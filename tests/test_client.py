...
class ClientTests(unittest.TestCase):
    def test_system_one_requests(self):
        ...
        for method, value, path in (
            ...
            with patch('open_cricket.client.urlopen', return_value=io.BytesIO(b'{"ok":true}')) as send:
        ...
        with patch('open_cricket.client.urlopen', return_value=io.BytesIO(b'{"models":[]}')) as send:
    ...
    def test_rejects_legacy_payload_without_network(self):
        with patch('open_cricket.client.urlopen') as send:
